...
%                  Requirements
%                  1. The file must be a Neuralynx Video Tracker data file.
%                       If writing to a new file, the correct extension is ".nvt"
%                  2. The filename must be a string and a row vector.
%                  Example:  
%                      Filename = 'C:\TestDirectory\TestFile.nvt'
%
...
%                  Example:   We want to extract fields for Timestamps and Targets Only.
%                      FieldSelection(1) = 1;
%                      FieldSelection(2) = 0;
%                      FieldSelection(3) = 0;
%                      FieldSelection(4) = 0;
...
%                  and Targets fields only, then we would have two parameters.  The order must also follow along with the
...
% 
%         Function( Filename, AppendFile, ExtractMode, 1, NumRecs, FieldSelection, Timestamps, Targets );
%         
...
%         ModeArray(3) = 9;
% 
%         Function( Filename, AppendFile, ExtractMode, ModeArray, NumRecs, FieldSelection, Timestamps, ExtractedX, ExtractedY, ExtractedAngle, Targets, Points, Header );
%         
