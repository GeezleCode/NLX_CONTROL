function s = nlx_control_settings_ATFO2
...
s.SendConditionParName         = {'TrialIDLow','TrialIDHigh','Block', 'Condition'};
...
s.SendConditionTrialIDIndex    = [2 1];
s.SendConditionBlockIndex      = 3;
s.SendConditionConditionIndex  = 4;
