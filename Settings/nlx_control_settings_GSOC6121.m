function s = nlx_control_settings_GSOC6121
...
s.SendConditionParNum = 4;
s.SendConditionParName = {'TrialIDHigh','TrialIDLow', 'Condition', 'Block'};
s.SendConditionPresentParName = {'StimulusCode', 'SiteCode'};
s.SendConditionPresentParRange = [1 144;1 2];
...
s.SendConditionTrialIDIndex = 2;
s.SendConditionBlockIndex = 4;
