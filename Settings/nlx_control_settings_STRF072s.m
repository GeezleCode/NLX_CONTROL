...
% s.RVCOStimArray = load(fullfile(fileparts(which('nlx_control_settings_STRF072S')),'STRF072S.txt'));
s.RVCOStimArray = load(fullfile(fileparts(which('nlx_control_settings_STRF072S')),'STRF120S.txt'));

s.CurrTrialTimeTicks = [0:500:6000];
...
%%
s.RFmapsize = [30 30]; % degrees
s.RFmappos = [-35,10];

%%
s.RVCOTau = [0 100 150 200];
s.RVCOTauBase = 0;
s.RVCOWin = [-25 0];
